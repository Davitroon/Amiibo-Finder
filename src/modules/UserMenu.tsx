...
import { IoPerson, IoCloudUpload, IoCloudDownload, IoTrash } from "react-icons/io5";
...
const UserMenu = () => {
    ...
    const handleExport = () => {
        ...
        link.href = url;
        link.download = `amiibo-collection-${new Date().toISOString().slice(0, 10)}.json`;
        ...
        <div className="user-menu-container">
            ...
            {isMenuOpen && (
                <div className="dropdown-menu">
                    <button className="dropdown-item" onClick={handleExport} title="Save your collection data as a JSON file">
                        <IoCloudDownload /> Export data
                    </button>
                    
                    <button className="dropdown-item" onClick={triggerImport} title="Load a collection data as a JSON file">
                    ...
                    <button className="dropdown-item danger" onClick={() => setShowDeleteConfirm(true)} title="Delete your current collection">
                        <IoTrash /> Delete Data
                    </button>
                </div>
            )}
